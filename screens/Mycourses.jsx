      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <ImageBackground className="h-[240px]" source={rounded}>
          ...
          <View className="flex-row justify-between">
            <View className="ml-5">
              <TextInput
                className="border-2   border-gray-100 w-[290px]  bg-white rounded-lg text-lg"
                placeholder="Search Courses"
                onChangeText={(text) => setSearch(text)}
                value={search}
              />
              <View className="absolute left-64 pt-4 ml-8">
          ...
          >
            <View className="flex-row mt-6">
              <View>
                <Text
                  className="text-white  rounded-3xl text-center 
              font-bold w-[50px] pb-1 p-1 bg-[#E67E22] mr-4 "
                >
                  All
                </Text>
              </View>
              <View>
                <Text
                  className="text-gray-500 font-bold rounded-3xl 
              bg-white text-center w-[87px] pb-1 p-1 mr-4"
                >
                  Progress
                </Text>
              </View>
              ...
              <View>
                <Text
                  className="text-gray-500 font-bold rounded-3xl 
              bg-white text-center w-[50px] pb-1 p-1 mr-4"
                >
                  New
                </Text>
              </View>
              <View>
                <Text
                  className="text-gray-500 font-bold rounded-3xl 
              bg-white text-center w-[87px] pb-1 p-1"
                >
                  Trending
                </Text>
              </View>
